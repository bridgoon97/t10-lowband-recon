...
|------|--------|----------|-------|
| L0::5.1_complexity::test_complexity_all_arms | PASS | 0.0 |  |
| L0::5.2_causality::test_causality | PASS | 0.0 |  |
| L0::5.2_causality::test_shape_arbitrary | PASS | 0.2 |  |
| L0::5.3_streaming::test_streaming_batch_equiv | PASS | 1.4 |  |
| L0::5.4_overfit::test_overfit_single_batch | PASS | 17.1 |  |
...
| L0::5.8_degradation::test_fullband_noise_snr | PASS | 0.6 |  |
...
| L0::5.9_export::test_export_all | PASS | 39.2 |  |
| L0::5.10_smoke::test_smoke_train | PASS | 56.8 |  |
| L0::5.10_smoke::test_smoke_train_noisy | PASS | 57.3 |  |
...
| L1::4_l1_adapter::test_l1_sensor_is_bandlimited_vs_ref | PASS | 2.6 |  |
| L1::5.11_smoke_l1::test_smoke_train_l1 | PASS | 13.4 |  |
