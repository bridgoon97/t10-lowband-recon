...
| L0::5.4_overfit::test_overfit_single_batch | PASS | 17.6 |  |
| L0::5.5_gradient::test_gradient_flow | PASS | 0.1 |  |
| L0::5.5_gradient::test_mr_stft_gradient | PASS | 0.2 |  |
...
| L0::5.8_degradation::test_fullband_noise_snr | PASS | 0.7 |  |
...
| L0::5.10_smoke::test_smoke_train | PASS | 55.4 |  |
| L0::5.10_smoke::test_smoke_train_noisy | PASS | 60.2 |  |
...
| Test | Status | Time (s) | Error |
|------|--------|----------|-------|
| L1::4_l1_adapter::test_l1_adapter_loads_and_protocol | PASS | 0.7 |  |
| L1::4_l1_adapter::test_l1_default_sensor_is_body_conduction | PASS | 0.7 |  |
| L1::4_l1_adapter::test_l1_pairs_are_intrarow_aligned | PASS | 0.6 |  |
| L1::4_l1_adapter::test_l1_sensor_is_bandlimited_vs_ref | PASS | 0.5 |  |
| L1::5.11_smoke_l1::test_smoke_train_l1 | PASS | 15.4 |  |
| L1::4b_l1_bandwidth::test_l1_sensor_effective_bandwidth | PASS | 3.8 |  |
